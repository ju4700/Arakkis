...
function Bazar({ showAll, onShowMore }: BazarProps) {
    ...
    const allProducts = [
        ...
        },
        {
            ...
            price: 380,
            unit: "কেজি",
            image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Rohu_at_Giant_Hypermarket_Kota_Damansara_20230203_105829.jpg/1200px-Rohu_at_Giant_Hypermarket_Kota_Damansara_20230203_105829.jpg",
            seller: "করিম ফিশারি",
            rating: 4.8,
            reviews: 45,
            stock: "স্টকে আছে",
